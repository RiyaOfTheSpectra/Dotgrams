...
" Sort todo by (first) context {{{3
    noremap  <script> <silent> <buffer> <localleader>sc :call todo#HierarchicalSort('@', '', 1)<CR>:w!<CR>
    noremap  <script> <silent> <buffer> <localleader>scp :call todo#HierarchicalSort('@', '+', 1)<CR>:w!<CR>
...
" Mark done {{{3
    nmap              <silent> <buffer> <localleader>x <Plug>DoToggleMarkAsDone :w!<CR>
...
" Remove completed {{{3
    nnoremap <script> <silent> <buffer> <localleader>D :call todo#RemoveCompleted()<CR>:w!<CR>

" Sort by due: date {{{3
    nnoremap <script> <silent> <buffer> <localleader>sd :call todo#SortDue()<CR>:w!<CR>
" try fix format {{{3
