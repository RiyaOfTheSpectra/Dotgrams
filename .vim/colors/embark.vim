...
" Space
let s:space0 = { "gui": "#16000b", "cterm": "NONE", "cterm16": "0"}
let s:space1 = { "gui": "#16000b", "cterm": "NONE", "cterm16": "NONE"}
let s:space2 = { "gui": "#2D2B40", "cterm": "233", "cterm16": "NONE" }
let s:space3 = { "gui": "#3E3859", "cterm": "233", "cterm16": "8"}
...
let s:green = { "gui": "#A1EFD3", "cterm": "168", "cterm16": "2"}
let s:dark_green = { "gui": "#62d196", "cterm": "119", "cterm16": "10"}

let s:yellow = { "gui": "#ffe6b3", "cterm": "127", "cterm16": "3"}
let s:dark_yellow = { "gui": "#F2B482", "cterm": "129", "cterm16": "11"}

let s:blue = { "gui": "#91ddff", "cterm": "159", "cterm16": "4"}
let s:dark_blue = { "gui": "#65b2ff", "cterm": "75", "cterm16": "12"}

let s:purple = { "gui": "#d4bfff", "cterm": "117", "cterm16": "5"}
let s:dark_purple = { "gui": "#a37acc", "cterm": "135", "cterm16": "13"}

let s:cyan = { "gui": "#87DFEB", "cterm": "173", "cterm16": "6"}
...
call s:h("Special",       {"fg": s:dark_blue})
...
call s:h("LineNr",        {"bg": s:purple, "fg": s:blue, "gui": "bold"})
hi LineNr guibg=NONE ctermbg=NONE

call s:h("CursorLineNr",  {"fg": s:space4, "bg": s:bg_dark})
